...
int main(int argc, const char * argv[])
{
    ...
    GLAppearance* apperance_0 =new GLAppearance("../../data/shaders/noisemap.vs", "../../data/shaders/noisemap.fs");
		//new GLAppearance("../../data/shaders/multi_texture.vs", "../../data/shaders/multi_texture.fs");
		//new GLAppearance("../../data/shaders/noisemap.vs", "../../data/shaders/noisemap.fs");
    ...
    material_0._diffuse_material = glm::vec3(0.5, 0.5, 0.5);//glm::vec3(0.8, 0.8, 0.0);
    material_0._ambient_material = glm::vec3(0.5, 0.5, 0.5);//glm::vec3(0.8, 0.8, 0.0);
    ...
    int texid = texture->loadAndCreateTextures("../../data/textures/landscape.bmp", "../../data/textures/noiseMap.bmp");
		//("../../data/textures/noiseMap.bmp", "../../data/textures/landscape.bmp");
		//("../../data/textures/landscape.bmp", "../../data/textures/noiseMap.bmp");
