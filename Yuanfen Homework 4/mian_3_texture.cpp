...
int main(int argc, const char * argv[])
{
    ...
    int texid = texture->loadAndCreateTextures("../../data/textures/texture_brick.bmp", "../../data/textures/light_512_512a.bmp","../../data/textures/texture_sun_512_512.bmp");
	//("../../data/textures/texture_brick.bmp", "../../data/textures/texture_sun_512_512.bmp","../../data/textures/light_512_512.bmp")
