...
private:
    ...
    static string      _glsl_names[];
#else
    const string      _glsl_names[4] = { "texture_background", "texture_foreground", "texture_middle","texture_blend"};
#endif
...
public:
    ...
    /*!
     ...
     @param path_and_file_texture_2 - path and file of the second image.
	 @param path_and_file_texture_3- path and file of the second image.
     @return int - the texture id when the texture was sucessfully loaded.
     */
