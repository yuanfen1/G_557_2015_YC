...
public:
    ...
    GLMaterial()
    {
		_glsl_names[0] = "ambient";
		_glsl_names[1] = "diffuse";
		_glsl_names[2] = "specular";
		_glsl_names[3] = "shininess";
		_glsl_names[4] = "emissive";
		_glsl_names[5] = "transparency";
		_glsl_struct = "allMaterials";
...
public:
    ...
    {
		_glsl_names[0] = "specular_intensity";
		_glsl_names[1] = "diffuse_intensity";
		_glsl_names[2] = "ambient_intensity";
		_glsl_names[3] = "attenuationCoefficient";
		_glsl_names[4] = "light_position";
		_glsl_object = "allLights";
...
public:
    ...
    GLSpotLightSource()
    {
		...
		_glsl_names[0] = "cone_angle";
		_glsl_names[1] = "cone_direction";
		_glsl_names[2] = "smooth_angle";
    }
