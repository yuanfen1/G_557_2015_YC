...
public:
    ...
    void setMatrix(glm::mat4& matrix);
    	...
    	void set_material(GLMaterial& material)
	{
		_material._diffuse_material = material._diffuse_material;
		_material._ambient_material = material._ambient_material;
		_material._specular_material = material._specular_material;
		_material._shininess = material._shininess;
		_material._emissive_material = material._emissive_material;
	}
protected:
