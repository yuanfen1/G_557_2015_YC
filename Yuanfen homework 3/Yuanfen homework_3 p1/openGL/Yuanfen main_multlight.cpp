//
//  oneball spotlight and direct light.cpp
//  HCI 557 homework 3 multilight
//
//  Created by Yuanfen on 9/10/15.
...
int main(int argc, const char * argv[])
{
    ...
    light_source1._cone_angle = 18.0; // in degree
    ...
    GLMaterial material;
    material._diffuse_material = glm::vec3(1.0, 0.0, 1.0);
    material._ambient_material = glm::vec3(1.0, 0.0, 1.0);
