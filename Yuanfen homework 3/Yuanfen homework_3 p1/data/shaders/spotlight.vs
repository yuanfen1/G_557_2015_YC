...
float smoothstep(float inner_edge, float outer_edge, float x)
{
    if(x < inner_edge)
        x = 0.0;
    else if(x > outer_edge)
        x = 1.0;
    else
        x = (x - inner_edge)/(outer_edge - inner_edge);
...
{                                                               
	...
	//if(light_to_surface_angle > cone_angle){
  	//	attenuation = 0.0;
	//}
	attenuation = smoothstep(cone_angle, smooth_angle, light_to_surface_angle) * attenuation; 
