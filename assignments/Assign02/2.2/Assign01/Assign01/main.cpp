...
void createBox(void)
{
    float* vertices = new float[54];  // Vertices for our square
    float *colors = new float[54]; // Colors for our vertices
	...
	colors[42] = 0.0; colors[43] = 0.3; colors[44] = 0.0; 

	vertices[45] = 3; vertices[46] = 0; vertices[47] = 1; 
	colors[45] = 0.0; colors[46] = 0.8; colors[47] = 0.0; 

	vertices[48] = 01; vertices[49] = 2; vertices[50] = 1; 
	colors[48] = 0.0; colors[49] = 0.5; colors[50] = 0.0; 

	vertices[51] = 3; vertices[52] = 1; vertices[53] = 1; 
	colors[51] = 1.0; colors[52] = 1.0; colors[53] = 1.0; 


/*	//Bottom pentagon  side 1												

	vertices[54] = 1; vertices[55] = 0; vertices[56] = 1; 
	...
	vertices[60] = 1; vertices[61] = 1; vertices[62] = 1; 
	colors[60] = 0.0; colors[61] = 0.0; colors[62] = 1.0; 

	//Bottom pentagon  side 2												  
	vertices[63] = 0; vertices[64] = 1; vertices[65] = 3; 
...
*/
    ...
    glBufferData(GL_ARRAY_BUFFER, 54 * sizeof(GLfloat), colors, GL_STATIC_DRAW); // Set the size and data of our VBO and set it to STATIC_DRAW
